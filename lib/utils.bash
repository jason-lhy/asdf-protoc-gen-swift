...
# NOTE: You might want to remove this if protoc-gen-swift is not hosted on GitHub releases.
...
list_all_versions() {
	...
	# Change this function if protoc-gen-swift has other means of determining installable versions.
	list_github_tags
}
